...
k = model.fit(np.array(training_x), np.array(training_y), epochs=200, batch_size=5, verbose=1)
...
#fitting and saving the model 
k = n1.fit(np.array(training_x), np.array(training_y), epochs=200, batch_size=5, verbose=1)
...
#fitting and saving the model 
k = n2.fit(np.array(training_x), np.array(training_y), epochs=200, batch_size=5, verbose=1)
